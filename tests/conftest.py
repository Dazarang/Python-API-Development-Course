...
TestingSessionLocal = sessionmaker(autocommit=False, autoflush=False, bind=engine) # SessionLocal is a class that is used to create a session
...
# Can run client and session (database) test separately
...
def test_user2(client):
    user_data = {"email": "dena2@gmail.com", "password": "password123"}
...
def test_user(client):
    user_data = {"email": "dena@gmail.com", "password": "password123"}
    res = client.post("/users/", json=user_data)
